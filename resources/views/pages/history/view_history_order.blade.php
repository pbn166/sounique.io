    ...
    <div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Phí Ship<span> {{number_format($details->product_feeship,0,',','.')}}Đ</span></li>

							<li>Tổng giảm <span>{{number_format($coupon_number,0,',','.')}}Đ</span></li>
							<li>Thành tiền <span>{{number_format($total_coupon,0,',','.')}}Đ</span></li>
						</ul>
					</div>
             <!-- <a class="btn" href="{{url('/print-order/'.$details->order_code)}}">In đơn hàng</a> -->
				</div>
                </div>
    <a target="_blank" class="btn" id="inhoadon" href="{{url('/print-order/'.$details->order_code)}}">In đơn hàng</a>
  </div>
