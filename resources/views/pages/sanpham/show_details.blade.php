							...
							<div class="product-information"><!--/product-information-->
								...
								<form>
									@csrf
                                            ...
                                            <input type="hidden" value="{{$value->product_file}}" class="cart_product_file_{{$value->product_file}}">
                                            <!-- $pro->product_file -->
								<span>
                                ...
                                <!-- <p><a href="$value->product_file">tài liệu:</b> {{$value->product_file}}</a>
                                @if($value->product_file)
                                    @php
                                    $filename = $value->product_file;
                                    $name = pathinfo($filename, PATHINFO_FILENAME);
                                    $extension = pathinfo($filename, PATHINFO_EXTENSION);
                                    @endphp
                                    @if($extension=='pdf')
                                    <a target="_blank" href="{{asset('public/uploads/document/'.$value->product_file)}}">Xem file</a>
                                    @elseif($extension=='docx')
                                    <a target="_blank" href="https://view.officeapps.live.com/op/view.aspx?src={{ url('public/uploads/document/'.$value->product_file) }}">Xem file</a><
                                    @endif
                                    @else
            <td>Không file</td> -->
            @endif
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										<li><a href=""><i class="fa fa-user"></i>Peuguin</a></li>
										<li><a href=""><i class="fa fa-clock-o"></i>9:41 AM</a></li>
										<li><a href=""><i class="fa fa-calendar-o"></i>15.12.2023</a></li>
									</ul>
									<style type="text/css">
										.style_comment {
