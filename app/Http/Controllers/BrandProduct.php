...
class BrandProduct extends Controller
{
       public function __construct(){
        $this->middleware('permission:add brand',['only'=> ['add_category_brand','save_category_brand']]);
        $this->middleware('permission:edit brand',['only'=> ['edit_category_brand','update_category_brand']]);
        $this->middleware('permission:delete brand',['only'=> ['delete_category_brand']]);
        $this->middleware('permission:list brand',['only'=> ['all_brand_product']]);
    }
