...
class CheckoutController extends Controller
{
  ...
  public function momo_payment(Request $request){
    ...
    $orderId = time() ."";
    $redirectUrl =  "http://localhost/shopbanhang/view-history-order/";
    $ipnUrl =  "http://localhost/shopbanhang/view-history-order/";
    $extraData = "";
...
public function vnpay_payment(Request $request){
    ...
    $vnp_Returnurl = "http://localhost/shopbanhang/checkout";
    $vnp_TmnCode = "FYNJUF47";//Mã website tại VNPAY
    $vnp_HashSecret = "HBLXREFGNKZIBBNJJSMTGSWQHGHFKZSJ"; //Chuỗi bí mật
...
public function checkout(Request $request){
  ...
  $customer = Customer::find(Session::get('customer_id'));
  return view('pages.checkout.show_checkout')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('city',$city)->with('slider',$slider)->with('category_post',$category_post)->with('customer', $customer);
}
