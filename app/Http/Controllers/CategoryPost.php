...
class CategoryPost extends Controller
{
    public function __construct(){
        $this->middleware('permission:add category post',['only'=> ['add_category_post','save_category_post']]);
        $this->middleware('permission:edit category post',['only'=> ['edit_category_post','update_category_post']]);
        $this->middleware('permission:delete category post',['only'=> ['delete_category_post']]);
        $this->middleware('permission:list category post',['only'=> ['all_category_post']]);
