...
class OrderController extends Controller
{
	public function __construct(){
        $this->middleware('permission:delete order',['only'=> ['order_code']]);
    }
	...
	public function print_order_convert($checkout_code){
        ...
        // Phần thông tin người đặt hàng
        $output .= '<div class="invoice">
            <div class="invoice-header">
                <h1>Công ty TNHH Sounique</h1>
                <img src="/public/uploads/logo/8.png">
            </div>
        ...
        $output .= '<div class="invoice-section">
                <h2>Ship hàng tới</h2>
                <table>
                    <tr>
        ...
        // Tính tổng giảm giá và tổng thanh toán
        if($coupon_condition == 1){
        ...
        // Tạo ra mã HTML hoàn chỉnh của trang hoá đơn
