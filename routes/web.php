...
Route::get('/danh-muc','CategoryProduct@all_sanpham');
...
Route::post('/danh-muc','CategoryProduct@product_cate');
...
Route::post('/onepay_payment','CheckoutController@onepay_payment');
